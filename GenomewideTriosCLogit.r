...
#Save the directories and interactions as vectors
...
#for (i in c(1:24)))
{
	...
	#For double-checking that the true minor allele is A1 in the original data (pulled into Genotypes.NumericalCoding.tsv)
	...
	#Count number of cases and [pseudo] controls
